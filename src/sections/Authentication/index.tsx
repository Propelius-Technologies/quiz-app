...
//   CustomButtonStyle,
// } from "@/src/components/common/CustomButton/OutlineButton";
import {
  Button,
  ButtonText,
  Logo,
  ...
  SignIN,
  WelcomeBox,
} from "@/src/sections/Authentication/style";
        ...
        <Box sx={WelcomeBox}>
          <Box sx={Logo}>
            <Image
              ...
              height={50}
            />
            <Typography sx={SignIN}>
              Please sign in with your provided email to get started
            </Typography>
          </Box>
          <Box sx={Button}>
            <OutlineButton
